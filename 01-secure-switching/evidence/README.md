...
- `secure-trunks.png` showing trunk mode and native VLAN
- Optional: a screenshot showing an unauthorized MAC being restricted or BPDU Guard reacting to an unexpected BPDU
